...
#define REQUESTING_TIP               @"正在加载……"
#define REQUEST_FAIL_TIP             @"加载失败！"
...
#define SCREEN_HEITHT               [UIScreen mainScreen].applicationFrame.size.width
